...
def _(estimator: SkDnn, trial):
    max_number_of_epochs = trial.suggest_int('max_number_of_epochs', 2)
    params = {
        ...
        'annealing_rounds': trial.suggest_int('annealing_rounds', 1),
        'swa_epochs': trial.suggest_int('swa_epochs', 1),
        'var_p': trial.suggest_float('var_p', 1.0),
